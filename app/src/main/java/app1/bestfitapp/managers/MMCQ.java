...
public class MMCQ {
    ...
    public static List<ColorValue> compute(List<ColorValue> pixels, int maxcolors) {
    ...
    private static List<ColorValue> getPixels(Bitmap image) {
        ...
        for (int i = 0; i < t.size(); i ++) {
            ...
            //
            //to remove white from list
            //
            //if (!(rr.r > 250 && rr.g > 250 && rr.b > 250)) {
            res.add(rr);
            //}
        }
        return res;
    ...
    private static int[] histogram(List<ColorValue> pixels) {
        int[] histogram = new int[1 << (3 * SIGBITS)];

        for (ColorValue pixel : pixels) {
    ...
    private static VBox vboxFromPixels(List<ColorValue> pixels, int[] histo) {
    ...
    private static ColorMap quantize(List<ColorValue> pixels, int maxcolors) {
    ...
    static class VBox implements Comparable {
        ...
        public ColorValue avg(boolean recompute) {
    ...
    static class ColorMap {
        private ArrayList<ColorValue> vboxes = new ArrayList<>();
        ...
        public List<ColorValue> palette() {
            return vboxes;
        }
